    ...
    <Card className="w-full max-w-md bg-zinc-950/80 backdrop-blur-xl border-zinc-800 shadow-2xl relative overflow-hidden">
      ...
      <CardContent className="space-y-4 z-10 relative">
        ...
        <div className="flex flex-col gap-3">
          <Button variant="outline" className="w-full h-12 bg-zinc-900/30 border-zinc-800 hover:bg-zinc-800 hover:text-white transition-all text-zinc-300">
      ...
      <CardFooter className="flex justify-center z-10 relative border-t border-border/40 pt-6 mt-2 pb-8">
        <p className="text-sm text-muted-foreground text-center">
          계정이 없으신가요?{" "}
          <Link href="/signup" className="text-amber-500 font-semibold hover:text-amber-400 hover:underline underline-offset-4 transition-all">
            가입하기
          </Link>
        </p>
      </CardFooter>
