...
OUT = Path("/Users/woosung/project/agy-project/nexus-core/exports/round3_redteam/04_평가·프로브/probe_answers_qt.json")
MODEL = "gemini-3.1-flash-lite"
STAGING_BOT = 3

CANDIDATES = {
    "Bot_T_정밀": RAGDIR / "Bot_T.md",
    "Bot_Q_통합": RAGDIR / "Bot_Q.md",
}
